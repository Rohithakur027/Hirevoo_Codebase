    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-background">
        <div className="flex flex-col items-center gap-2">
          ...
          <p className="text-sm text-muted-foreground">Loading Hirevoo...</p>
        </div>
      </div>
    );
  }
      ...
      >
        ...
        <Card className="border-0 shadow-xl bg-card/50 backdrop-blur-sm">
          ...
          <CardContent className="space-y-4">
            ...
            <Button 
              variant="outline" 
              className="w-full h-11 gap-2 border-muted-foreground/20 hover:bg-secondary/50"
            ...
            <div className="space-y-4">
              ...
              <Button className="w-full h-11 gap-2 bg-primary text-primary-foreground hover:bg-primary/90 shadow-lg shadow-primary/20">
                Sign In
